...
image_alt: "GitHub page showing an Invalid Notebook error for a Jupyter file"
---

## The Problem

When trying to view Jupyter notebooks on GitHub, we sometimes see an “Invalid Notebook” message (see screenshot at the top of this post).
